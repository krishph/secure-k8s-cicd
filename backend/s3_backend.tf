...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "ikrish-tf-s3-tfstate" {
...
resource "aws_s3_bucket_public_access_block" "ikrish-tf-s3-tfstate" {
  bucket = aws_s3_bucket.ikrish-tf-s3-tfstate.id
